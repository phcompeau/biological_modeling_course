...
Load the `CellBlender_Tutorial_Template.blend` file that you generated in the [Random Walk Tutorial](tutorial-random-walk). Save this file as a new file named `det_gray_scott.blend`.
